<template>
  <section class="blog">
    <div class="py-8 md:py-16 text-center">
      <h1 class="text-lg md:text-xl lg:text-4xl xl:text-6xl">Letters From the Soul, for the One Who Holds My Heart ❤️</h1>
      <h2 class="text-base md:text-lg lg:text-xl xl:text-2xl">
        Please don’t stop talking to me after reading this.
      </h2>
    </div>
